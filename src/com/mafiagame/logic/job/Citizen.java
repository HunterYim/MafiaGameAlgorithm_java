...
public class Citizen extends Job {
    ...
    private static final String JOB_NAME = "시민";
    private static final Team TEAM = Team.CITIZEN;
    private static final JobType JOB_TYPE = JobType.CITIZEN;
    private static final String DESCRIPTION = "아무런 능력이 없지만, 투표를 통해 마피아를 색출해야 합니다.";
